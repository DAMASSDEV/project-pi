...
class SettingsMenuSectionWidget extends StatelessWidget {
  ...
  const SettingsMenuSectionWidget({super.key, this.personalizationData});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoRow(
                  'Kondisi Kesehatan',
                  conditions.isNotEmpty ? conditions.join(', ') : 'Tidak Ada',
                ),
                if (data['other_conditions'] != null &&
                    data['other_conditions'].toString().isNotEmpty)
                  _buildInfoRow('Kondisi Lainnya', data['other_conditions']),
                _buildInfoRow(
                  'Alergi',
                  allergies.isNotEmpty ? allergies.join(', ') : 'Tidak Ada',
                ),
                _buildInfoRow(
                  'Pantangan',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoRow(
                  'Makanan Favorit',
                  preferences.isNotEmpty ? preferences.join(', ') : '-',
                ),
                  ...
                  _buildMenuTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AboutNutrifyPage(),
                        ),
                      );
                    },
                  ),
